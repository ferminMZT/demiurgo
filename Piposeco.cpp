...
// Tan solo sirve para visualizar en pantalla la expresiñn simplificada de la pila.
// Imprime la expresiñn en in-orden, por lo cual funciona recursivamente...
void Piposeco::verSimplificado(int nPipo)
{
	...
	if(entradas[nPipo].aridad == 0)
	{
		if(entradas[nPipo].tipoNodo == CONSTANTE)
			...
			// ñcomo acceder a su nombre? -> Al crear la pila en apilar meto el nombre
