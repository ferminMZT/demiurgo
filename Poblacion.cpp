...
int Poblacion::generacionD(int nHijos)
{
 ...
 while(numIteraciones != numIndividuos && !errorAlcanzado())
 {
  ...
  if(errHijo1 < errPadre)	// Si el 2ñ hijo es mejor que el padre, los 2 primeros hijos se salvan
...
// al resto; despues se sustituye a los caidos por una nueva poblacion aleatoria ñy enriquecida?, como se
